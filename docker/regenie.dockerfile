...
RUN curl -sSo /tmp/startup-hook.sh https://raw.githubusercontent.com/statgenetics/statgen-courses/master/src/startup-hook.sh && \
   /bin/bash /tmp/startup-hook.sh regenie 1 && rm -f /tmp/startup-hook.sh

USER jovyan

# Download data to docker image
RUN mkdir -p /home/jovyan/.work
RUN cd /home/jovyan/.work && curl -fsSL https://statgen.us/files/2021/11/mwe_regenie.tar.gz -o mwe_regenie.tar.gz && tar -xzvf mwe_regenie.tar.gz && rm -rf *.tar.gz && rm -f /home/jovyan/.work/regenie_statgen_mwe/._*
