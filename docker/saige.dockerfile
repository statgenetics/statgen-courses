...
RUN curl -fsSL https://statgen.us/files/2020/01/saige_data.tar.gz -o saige_data.tar.gz && tar -xzvf saige_data.tar.gz && mkdir input && mv /home/jovyan/saige_data/* input/ && rm -rf *.tar.gz saige_data
