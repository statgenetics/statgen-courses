...
RUN curl -fsSL http://statgen.us/files/2017/09/data/igv_exercise.zip -o igv_exercise.zip && unzip igv_exercise.zip && rm -f igv_exercise.zip && mv igv/*.* /usr/local/src/igv-webapp/dist
